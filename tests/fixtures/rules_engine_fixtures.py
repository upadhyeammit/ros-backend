...
@pytest.fixture
def mock_azure_instance():
    """Mock Azure instance type."""
    mock_azure = Mock()
    mock_azure.raw = "Standard_D2s_v3"
    return mock_azure
...
@pytest.fixture
def mock_cloud_provider_azure():
    """Mock CloudProvider for Azure."""
    mock_cp = Mock()
    mock_cp.cloud_provider = "azure"
    mock_cp.AZURE = "azure"
    return mock_cp
