...
def readable_evalution(ret):
    ERROR_KEYs = [
        ...
        (ERROR_KEY_UNDERSIZED, any, (RosKeys.CPU_UNDERSIZED, RosKeys.MEMORY_UNDERSIZED, RosKeys.IO_UNDERSIZED)),
        (ERROR_KEY_OVERSIZED, all, (RosKeys.CPU_OVERSIZED, RosKeys.MEMORY_OVERSIZED, RosKeys.IO_OVERSIZED)),
        (ERROR_KEY_UNDER_PRESSURE, any, (RosKeys.CPU_UNDERSIZED_BY_PRESSURE, RosKeys.MEMORY_UNDERSIZED_BY_PRESSURE, RosKeys.IO_UNDERSIZED_BY_PRESSURE)),
    ]
    COMP_KEYs = [
        # FIXME: RosKeys.IDLE -> idle?
        ('idle', (RosKeys.IDLE,)),
        ('cpu', (RosKeys.CPU_IDLING, RosKeys.CPU_OVERSIZED, RosKeys.CPU_UNDERSIZED, RosKeys.CPU_UNDERSIZED_BY_PRESSURE)),
        ('memory', (RosKeys.MEMORY_OVERSIZED, RosKeys.MEMORY_UNDERSIZED, RosKeys.MEMORY_UNDERSIZED_BY_PRESSURE)),
        ('io', (RosKeys.IO_OVERSIZED, RosKeys.IO_UNDERSIZED, RosKeys.IO_UNDERSIZED_BY_PRESSURE)),
    ]
...
def no_pmlog_summary(ros_cfg, old_pm, cli_cfg, new_pm):
    ...
    # if (ros_cfg and old_pm is None) or (cli_cfg and
